...
const MEALS = {
  breakfast: [
    ...
    { name:'Cottage Cheese & Berry Bowl',       calories:320, protein:38, carbs:24, fat:6,  easy:true,  must:['Low-fat cottage cheese','Mixed berries'],    nice:['Honey','Chia seeds'],            notes:'Spoon 250g cottage cheese into a bowl. Top with 80g berries and a drizzle of honey. Zero cooking.' },
  ...
  snack: [
    ...
    { name:'0% Greek Yogurt',             calories:140, protein:20, carbs:10, fat:1,  easy:true, must:['0% Greek yogurt'],                  nice:['Berries'],                        notes:'150g 0% Greek yogurt with a small handful of berries.' },
    { name:'Cottage Cheese & Cucumber',   calories:145, protein:22, carbs:6,  fat:3,  easy:true, must:['Low-fat cottage cheese','Cucumber'],nice:[],                                 notes:'150g cottage cheese with sliced cucumber. High protein, very low calorie.' },
    { name:'Tuna & Rice Cakes',           calories:160, protein:24, carbs:10, fat:2,  easy:true, must:['Tinned tuna'],                      nice:['Rice cakes','Lemon'],             notes:'Drain 1 tin tuna, serve on 2 plain rice cakes with a squeeze of lemon.' },
    { name:'2 Hard-Boiled Eggs',          calories:155, protein:13, carbs:1,  fat:10, easy:true, must:['Eggs'],                             nice:[],                                 notes:'Batch-boil 6 eggs Sunday. Keep in fridge all week — grab 2 whenever needed.' },
  ...
  lunch: [
    ...
    { name:'Tuna & Rice Bowl',               calories:430, protein:50, carbs:36, fat:7,  easy:true,  must:['Tinned tuna','Cucumber','Cherry tomatoes'],nice:['Basmati rice','Soy sauce'],      notes:'Cook rice Sunday. Mix 2 tins tuna with chopped veg. Add rice and season with soy sauce.' },
    { name:'Chicken & Cottage Cheese Salad', calories:400, protein:55, carbs:8,  fat:10, easy:true,  must:['Chicken breast','Low-fat cottage cheese','Mixed leaves'], nice:['Cherry tomatoes','Cucumber'], notes:'Slice cold batch chicken over leaves. Add a big dollop of cottage cheese and veg. No dressing needed.' },
  ...
  dinner: [
    ...
    { name:'Lean Beef Chilli',                    calories:510, protein:52, carbs:32, fat:16, easy:true,  must:['Lean beef mince','Tinned tomatoes','Kidney beans'], nice:['Chilli flakes','Cumin','Garlic'], notes:'Brown mince, add spices, tomatoes and beans. Simmer 20 mins. Batch well — doubles as lunch.' },
